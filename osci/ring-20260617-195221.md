...
recording that pinned the session model: **a ~1 s TV20/S pulse on line 4 latches WF26_K1, the handset
...
- **Line 4 is held by the *handset*, not the TV20/S.** Line 4 sits steady at 9.20 V for ~9.7 s (gong
  ...
  latched WF26_K1 contact. The TV20/S only **pulses line 4 high for ~1 s** to pull WF26_K1 in; after
...
- **No handset, no hold.** A session needs a handset present to seal line 4 in: with P4 floating
  ...
  `session-…102532`, the floating-P4 capture, and `other-station-…132858`.)
- **The door-open ends it by breaking the seal-in — *not* by the TV20/S dropping line 4.** At 159.25 s
  ...
  reaches the coil. (`ring4` resolves this to a ~6 ms break-before-make, with P2 *rising* as the coil
