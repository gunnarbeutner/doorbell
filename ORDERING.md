...
| **K6 return sense R35/R44** | R35 is 10 kΩ from +3V3 to `K6_RET`; R44 is 100 kΩ (existing BOM part C25803) from `K6_RET` to GPIO4/`K5_SENSE_N`. Confirm neither resistor lands on the wrong side of R44 | a GPIO fault can bypass K5's physical K6 interlock, or session sense can float/invert |
