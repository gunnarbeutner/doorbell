...
(~2.4 s, ≈2.0 s with the 16 V cap's bias derating) still clears the 1.75 s pulse. Bench-measure the
release; a 74LVC1G17 Schmitt is the permanent fix if a predictable time is ever wanted. **D11 (1N4148W)** dumps C20 the instant DOOR_DRV drops, re-arming for
