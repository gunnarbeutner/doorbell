...
|------|--------|--------|-----|-------|
| IO20 | 26 | K1 gate — **TX (PTT)**: the dual K1 sources the P2 handshake + gates the codec onto line 3 (high-Z at idle, BUS-1) | out | PTT_DRV → R4+R24 (300 Ω each) → K1's two SSR LEDs; R7 10 k pull-down ⇒ off at boot |
